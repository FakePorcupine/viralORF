# Global variable definitions to satisfy R CMD check constraints ------------
if(getRversion() >= "2.15.1") {
  utils::globalVariables(c(
    "%", "%>%", "ORF_ID", "ORFs", "V1", "aes", "block_seq_number", "case_when",
    "category", "coord_cartesian", "correct_frame_lookup", "element_blank",
    "element_text", "end", "frame", "geom_point", "ggplot", "ggsave", "ggtitle",
    "group_by", "kozak_dinuc", "left_join", "longest_orf_placeholder", "map",
    "map2_chr", "map_chr", "nuc_sequence", "nuc_sequence_lower", "placeholder_frame",
    "plot_layout", "position", "processed_sequence", "pull", "read.csv", "row_number",
    "scale_color_manual", "scale_shape_manual", "seq_name", "start", "startDefinition",
    "theme", "theme_bw", "theme_void", "translated_aa", "width", "write.csv", "xlab", "ylab", "seq"
  ))
}
...
#' @param output_prefix Character string giving the prefix for output plot files.
#' @importFrom magrittr %>%
#' @export
